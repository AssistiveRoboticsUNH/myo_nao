...
const int NaoExercise3S::END_FLAG = -1337;

ProgramStatus NaoExercise3S::getStatus() {
    return status;
}

void NaoExercise3S::myo_l_callback(geometry_msgs::Quaternion msg) {
...
void NaoExercise3S::myo_u_callback(geometry_msgs::Quaternion msg) {
    if(status == EXERCISING) {
...
void NaoExercise3S::mode_callback(std_msgs::Int32 mode) {
    ...
    switch(mode.data) {
        ...
        case 2:
            status = EXERCISING;
            myo_l_sub = n.subscribe<geometry_msgs::Quaternion>("/l_lower_leg_data_vec", 10, &NaoExercise3S::myo_l_callback, this);
            myo_u_sub = n.subscribe<geometry_msgs::Quaternion>("/r_foot_data_vec", 10, &NaoExercise3S::myo_u_callback, this);
            myo_u_sub = n.subscribe<geometry_msgs::Quaternion>("/r_foot_data_vec", 10, &NaoExercise3S::myo_u_callback, this);
            break;
...
void NaoExercise3S::progress_callback(std_msgs::Float64 progress) {
...
void NaoExercise3S::playback_u_callback(geometry_msgs::Quaternion msg) {
    
    myo_u_callback(msg);

}

void NaoExercise3S::playback_l_callback(geometry_msgs::Quaternion msg) {
    ...
    if(msg.x == END_FLAG || msg.y == END_FLAG || msg.z == END_FLAG || msg.w == END_FLAG) {
        ...
        myo_l_sub = n.subscribe<geometry_msgs::Quaternion>("/myo/l/ort", 10, &NaoExercise3S::myo_l_callback, this);
        myo_u_sub = n.subscribe<geometry_msgs::Quaternion>("/myo/u/ort", 10, &NaoExercise3S::myo_u_callback, this);
        status = EXERCISING;
    } else {
        pubQuat2NaoArm(msg);
    }
...
void NaoExercise3S::pubQuat2NaoArm(geometry_msgs::Quaternion msg) {
...
void NaoExercise3S::begin() {
    playback_l_sub = n.subscribe<geometry_msgs::Quaternion>("/exercise/l/playback", 10, &NaoExercise3S::playback_l_callback, this);
    playback_u_sub = n.subscribe<geometry_msgs::Quaternion>("/exercise/u/playback", 10, &NaoExercise3S::playback_u_callback, this);
...
void NaoExercise3S::posture_setup() {
...
NaoExercise3S::NaoExercise3S() {
    ...
    mode_sub = n.subscribe<std_msgs::Int32>("/exercise/mode", 10, &NaoExercise3S::mode_callback, this);
    progress_sub = n.subscribe<std_msgs::Float64>("/exercise/progress", 10, &NaoExercise3S::progress_callback, this);
